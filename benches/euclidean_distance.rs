...
fn word2vec_euclidean_group(c: &mut Criterion) {
    ...
    let dataset_path_string = String::from("data/word2vec-google-news-300_50000_lowercase/base.fbin");
    ...
    group.bench_function("word2vec euclidean 0 1", |b| b.iter(|| dataset.compare_euclidean(0, 1)));
    group.bench_function("word2vec euclidean 0 8", |b| b.iter(|| dataset.compare_euclidean(0, 8)));
    group.bench_function("word2vec euclidean 0 1000", |b| b.iter(|| dataset.compare_euclidean(0, 1000)));
}
